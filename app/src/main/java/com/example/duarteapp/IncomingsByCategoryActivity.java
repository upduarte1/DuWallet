...
public class IncomingsByCategoryActivity extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_incomings_by_category);
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(IncomingsByCategoryActivity.this, DashboardActivity.class);
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    for (var document : queryDocumentSnapshots) {
                        ...
                        if (date != null && date.matches("\\d+/\\d+/\\d+")) {
                            ...
                            if (month == selectedMonth && year == selectedYear && "Ganho".equals(type)) {
    ...
    private void setupPieChart(Map<String, Double> categoryTotals) {
        ...
        PieDataSet dataSet = new PieDataSet(entries, "Ganhos");
